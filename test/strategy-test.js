...
var PublicClientStrategy = require('../lib/strategy');
...
vows.describe('PublicClientStrategy').addBatch({
  ...
  'strategy handling a request': {
    topic: function() {
      var strategy = new PublicClientStrategy(function(clientId, clientSecret, done) {
  ...
  'strategy with passReqToCallback=true option': {
    topic: function() {
      var strategy = new PublicClientStrategy({passReqToCallback:true}, function(req, clientId, clientSecret, done) {
